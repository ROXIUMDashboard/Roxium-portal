...
> **Note added at merge time.** This map records the repository as audited on the
> `claude/bhfa-2027-agenda-tool-o0ph8r` branch. `bhfa-2027/` was deliberately **not**
> merged into `main` — it is an unrelated product, and the ROXIUM release was separated
> from it. Every other path above is accurate for `main`; this handoff package is left
> otherwise unedited, because it is a dated record rather than a live description.
